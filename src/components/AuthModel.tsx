        ...
        <>
            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
                <DialogTrigger asChild>
                    <button className='rounded-full text-white tracking-wider bg-primary w-[70%] px-4 py-2 text-base hover:scale-95 transition duration-300 hover:bg-transparent hover:text-black hover:border-primary hover:border' onClick={() => {
                        if (actionToPerform === "Logout") {
                            handleLogout()
                        ...
                        {
                            actionToPerform === "Login" ? "Login" : "Logout"
                        }
                    </button>
                </DialogTrigger>
                <DialogContent>
